...
SUSPICIOUS_HTTP_REQUEST_REGEXES = (
    ...
    ("potential dns changer", r"\b(staticPriDns|staticSecDns|pppoePriDns|pppoeSecDns|wan_dns1|wan_dns2|dnsPrimary|dnsSecondary|dnsDynamic|dnsRefresh|DNS_FST|DNS_SND)=")
)
