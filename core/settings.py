...
ALERT_POLL_PERIOD = 2                   # seconds between reads of the day's log by core/alert.py
ALERT_SEVERITY_ORDER = ("low", "medium", "high")
MAX_ALERT_THROTTLE_KEYS = 10000         # bound on the (source, trail) throttle table
