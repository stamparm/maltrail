...
class ColorizedStream:
    def __init__(self, original):
        ...
        self._type_colors = {"DNS": BACKGROUND.BLUE, "UA": BACKGROUND.MAGENTA, "IP": BACKGROUND.RED, "URL": BACKGROUND.YELLOW, "HTTP": BACKGROUND.GREEN, "IPORT": BACKGROUND.RED, "PATH": BACKGROUND.CYAN, "PORT": BACKGROUND.DARK_GRAY, "CERT": BACKGROUND.OLIVE}
