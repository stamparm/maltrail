...
TESTS="test_addr test_common test_datatype test_ignore test_config test_trailsdict test_quic_sni test_tls_intel test_httpd test_log_condense test_logd test_meta test_geo test_reference test_doctests test_enums test_parallel test_options test_doctor test_confidence test_index test_adversarial test_frontend test_update test_debug_artifacts test_check_trails test_detect_test test_smoke test_alert test_colorized test_redistribution test_refs test_refnet test_logfmt test_version_sync test_workflows"
