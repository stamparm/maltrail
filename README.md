...
```
aboc.txt, adwind.txt, alienspy.txt, almalocker.txt, 
alureon.txt, android_acecard.txt, android_adrd.txt, 
android_alienspy.txt, android_arspam.txt, 
android_backflash.txt, android_basebridge.txt, 
android_boxer.txt, android_chuli.txt, android_claco.txt, 
android_coolreaper.txt, android_counterclank.txt, 
android_cyberwurx.txt, android_dendoroid.txt, 
android_dougalek.txt, android_droidjack.txt, 
android_droidkungfu.txt, android_enesoluty.txt, 
android_ewalls.txt, android_exprespam.txt, 
android_fakebanco.txt, android_fakedown.txt, 
android_fakeinst.txt, android_fakelog.txt, 
android_fakemart.txt, android_fakemrat.txt, 
android_fakeneflic.txt, android_fakesecsuit.txt, 
android_feabme.txt, android_flexispy.txt, android_frogonal.txt, 
android_geinimi.txt, android_ghostpush.txt, 
android_ginmaster.txt, android_gmaster.txt, android_godwon.txt, 
android_golddream.txt, android_gonesixty.txt, 
android_ibanking.txt, android_kemoge.txt, 
android_lockdroid.txt, android_lovetrap.txt, 
android_maistealer.txt, android_maxit.txt, 
android_oneclickfraud.txt, android_opfake.txt, 
android_ozotshielder.txt, android_pikspam.txt, 
android_pjapps.txt, android_qdplugin.txt, android_repane.txt, 
android_roidsec.txt, android_samsapo.txt, android_sandorat.txt, 
android_selfmite.txt, android_simplocker.txt, 
android_skullkey.txt, android_sndapps.txt, 
android_spytekcell.txt, android_stealer.txt, android_stels.txt, 
android_teelog.txt, android_tetus.txt, android_tonclank.txt, 
android_torec.txt, android_uracto.txt, android_usbcleaver.txt, 
android_walkinwat.txt, android_windseeker.txt, 
android_zertsecurity.txt, androm.txt, andromem.txt, angler.txt, 
anuna.txt, arec.txt, aridviper.txt, artro.txt, autoit.txt, 
avalanche.txt, avrecon.txt, axpergle.txt, babar.txt, 
bachosens.txt, badblock.txt, balamid.txt, bamital.txt, 
bankapol.txt, bankpatch.txt, banloa.txt, banprox.txt, 
bayrob.txt, bedep.txt, blackenergy.txt, blackvine.txt, 
blockbuster.txt, bredolab.txt, bubnix.txt, bucriv.txt, 
buterat.txt, camerashy.txt, carbanak.txt, carberp.txt, 
careto.txt, casper.txt, cerber.txt, changeup.txt, chanitor.txt, 
chekua.txt, cheshire.txt, chewbacca.txt, chisbur.txt, 
cleaver.txt, cloud_atlas.txt, conficker.txt, contopee.txt, 
copykittens.txt, corebot.txt, cosmicduke.txt, couponarific.txt, 
criakl.txt, cridex.txt, crilock.txt, cryakl.txt, 
cryptinfinite.txt, cryptodefense.txt, cryptolocker.txt, 
cryptowall.txt, ctblocker.txt, cutwail.txt, darkhotel.txt, 
defru.txt, desertfalcon.txt, destory.txt, dnschanger.txt, 
dnsmessenger.txt, dnstrojan.txt, dorifel.txt, dorkbot.txt, 
drapion.txt, dridex.txt, dukes.txt, dursg.txt, dyreza.txt, 
elf_aidra.txt, elf_billgates.txt, elf_darlloz.txt, 
elf_ekoms.txt, elf_fysbis.txt, elf_groundhog.txt, 
elf_hacked_mint.txt, elf_mayhem.txt, elf_mokes.txt, 
elf_pinscan.txt, elf_rekoobe.txt, elf_shelldos.txt, 
elf_sshscan.txt, elf_themoon.txt, elf_turla.txt, elf_xnote.txt, 
elf_xorddos.txt, elpman.txt, emogen.txt, emotet.txt, 
equation.txt, evilbunny.txt, ewind.txt, expiro.txt, fakeav.txt, 
fakeran.txt, fantom.txt, fareit.txt, fbi_ransomware.txt, 
fiexp.txt, fignotok.txt, fin4.txt, finfisher.txt, 
fraudload.txt, fynloski.txt, fysna.txt, gamarue.txt, gauss.txt, 
gbot.txt, generic.txt, golroted.txt, gozi.txt, groundbait.txt, 
harnig.txt, hawkeye.txt, helompy.txt, hiloti.txt, hinired.txt, 
htran.txt, immortal.txt, injecto.txt, ios_keyraider.txt, 
ios_muda.txt, ios_oneclickfraud.txt, ios_specter.txt, 
ismdoor.txt, jenxcus.txt, kegotip.txt, keydnap.txt, 
kingslayer.txt, kolab.txt, koobface.txt, korgo.txt, 
korplug.txt, kovter.txt, kradellsh.txt, kulekmoko.txt, 
lazarus.txt, locky.txt, lollipop.txt, lotus_blossom.txt, 
luckycat.txt, majikpos.txt, malwaremustdie.org.csv, 
marsjoke.txt, mdrop.txt, mebroot.txt, mestep.txt, 
mhretriev.txt, miniduke.txt, misogow.txt, modpos.txt, 
morto.txt, nanocor.txt, nbot.txt, necurs.txt, nemeot.txt, 
neshuta.txt, nettraveler.txt, netwire.txt, neurevt.txt, 
nexlogger.txt, nivdort.txt, nonbolqu.txt, nuqel.txt, nwt.txt, 
nymaim.txt, odcodc.txt, oficla.txt, onkods.txt, optima.txt, 
osx_keranger.txt, osx_keydnap.txt, osx_salgorea.txt, 
osx_wirelurker.txt, palevo.txt, pdfjsc.txt, pegasus.txt, 
pepperat.txt, phytob.txt, picgoo.txt, pift.txt, plagent.txt, 
plugx.txt, ponmocup.txt, poshcoder.txt, potao.txt, 
powelike.txt, proslikefan.txt, pushdo.txt, pykspa.txt, 
qakbot.txt, quasar.txt, ramnit.txt, ransirac.txt, 
reactorbot.txt, redoctober.txt, redsip.txt, remcos.txt, 
renocide.txt, reveton.txt, revetrat.txt, rovnix.txt, 
runforestrun.txt, russian_doll.txt, rustock.txt, sakurel.txt, 
sality.txt, satana.txt, sathurbot.txt, scarcruft.txt, 
scarletmimic.txt, scieron.txt, seaduke.txt, sednit.txt, 
sefnit.txt, selfdel.txt, shifu.txt, shylock.txt, siesta.txt, 
silentbrute.txt, silly.txt, simda.txt, sinkhole_abuse.txt, 
sinkhole_anubis.txt, sinkhole_arbor.txt, 
sinkhole_bitdefender.txt, sinkhole_blacklab.txt, 
sinkhole_botnethunter.txt, sinkhole_certgovau.txt, 
sinkhole_certpl.txt, sinkhole_checkpoint.txt, 
sinkhole_cirtdk.txt, sinkhole_conficker.txt, 
sinkhole_cryptolocker.txt, sinkhole_drweb.txt, 
sinkhole_dynadot.txt, sinkhole_dyre.txt, sinkhole_farsight.txt, 
sinkhole_fbizeus.txt, sinkhole_fitsec.txt, sinkhole_fnord.txt, 
sinkhole_gameoverzeus.txt, sinkhole_georgiatech.txt, 
sinkhole_gladtech.txt, sinkhole_honeybot.txt, 
sinkhole_kaspersky.txt, sinkhole_microsoft.txt, 
sinkhole_rsa.txt, sinkhole_secureworks.txt, 
sinkhole_shadowserver.txt, sinkhole_sidnlabs.txt, 
sinkhole_sinkdns.txt, sinkhole_sofacy.txt, 
sinkhole_sugarbucket.txt, sinkhole_tech.txt, 
sinkhole_unknown.txt, sinkhole_virustracker.txt, 
sinkhole_wapacklabs.txt, sinkhole_zinkhole.txt, skeeyah.txt, 
skynet.txt, skyper.txt, smsfakesky.txt, snake.txt, snifula.txt, 
snort.org.csv, sockrat.txt, sofacy.txt, sohanad.txt, 
spyeye.txt, stabuniq.txt, stonedrill.txt, stuxnet.txt, 
synolocker.txt, tdss.txt, teamspy.txt, teerac.txt, 
teslacrypt.txt, themida.txt, tibet.txt, tinba.txt, torpig.txt, 
torrentlocker.txt, troldesh.txt, turla.txt, unruy.txt, 
upatre.txt, utoti.txt, vawtrak.txt, vbcheman.txt, vinderuf.txt, 
virtum.txt, virut.txt, vittalia.txt, vobfus.txt, 
volatilecedar.txt, vundo.txt, waledac.txt, waterbug.txt, 
wecorl.txt, wndred.txt, xadupi.txt, xcodeghost.txt, xtrat.txt, 
yenibot.txt, yimfoca.txt, zaletelly.txt, zcrypt.txt, zemot.txt, 
zeroaccess.txt, zeus.txt, zherotee.txt, zlader.txt, zlob.txt, 
zombrari.txt, zxshell.txt, etc.
```
