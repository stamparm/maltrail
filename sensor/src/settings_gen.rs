...
/// Every option name any parser accepts; an unlisted name in maltrail.conf is a typo
pub const KNOWN_CONFIG_OPTIONS: &[&str] = &[
    "ALERT_FORMAT",
    "ALERT_SEVERITY",
    "ALERT_THROTTLE",
    "ALERT_WEBHOOK_URL",
