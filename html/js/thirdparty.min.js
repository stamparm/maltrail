/* Maltrail frontend third-party bundle. PapaParse 5.5.4 (MIT) — the SOLE third-party runtime
   dependency of the redesigned UI (everything else is vanilla). To update: drop in a newer
   papaparse min build below this banner. */
/* @license
Papa Parse
v5.5.4
