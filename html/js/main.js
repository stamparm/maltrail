                    ...
                    if (!(ip in CHECK_IP)) {
                        ...
                        .done(function(json) {
                            ...
                            if (json.worst_asns === "true")
                                this.cell.append($("<img src='images/thief.png' class='worst_asns' title='worst ASNs'>").tooltip());
                        });
                    }
                        ...
                        cell.append(span_ip);
                        if (json.worst_asns === "true")
                            cell.append($("<img src='images/thief.png' class='worst_asns' title='worst ASNs'>").tooltip());
                    }
                    else {
