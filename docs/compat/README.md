...
**12 platforms, 94 capabilities verified, 2 not applicable, 0 failing.** Last recorded 2026-09-04.
...
- sensor did not start: /src/tests/install/assert.sh: line 86: /usr/local/bin/maltrail-sensor: not found
